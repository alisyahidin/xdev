...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  const isShowMenu = (isMobile !== null && isMobile && showMenu)

  return (
    <motion.div variants={wrapperVariants} initial="transparent" animate={isShowMenu ? 'transparent' : mode} className="fixed py-4 sm:py-6 top-0 left-0 w-full z-50 sm:z-10">
      <div className="container flex justify-between items-center">
        <Link href="/">
          <svg onClick={() => showMenu && setShowMenu(false)} className="cursor-pointer h-5 sm:h-8" viewBox="0 0 245 66" fill="none" xmlns="http://www.w3.org/2000/svg">
