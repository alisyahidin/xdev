...
const Arrow: React.FC<ArrowProps> = ({ size = 49, primaryColor = '#EB5757', secondaryColor = '#FFFFFF', ...props }) => {
  return (
    <svg {...props} height={size} viewBox="0 0 72 49" fill="none" xmlns="http://www.w3.org/2000/svg">
      <ellipse fill={primaryColor} cx="47.3286" cy="24.5" rx="24.6713" ry="24.5" />
