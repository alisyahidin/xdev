...
const Works: React.FC<WorksProps> = () => {
  return (<>
    ...
    >
      <div className="container flex h-full py-16 text-white">
        <div className="flex-1 flex justify-between items-start">
          <h1 className="text-5xl font-bold">
            Testimonials
          </h1>
          <svg className="mt-4" width="67" height="40" viewBox="0 0 67 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex-1 p-4">
          {testimonials.map((testi, index) => (
            <div className="mx-6" key={index}>
              <p className="mb-3 text-lg whitespace-pre-line">{testi.text}</p>
              <p>
